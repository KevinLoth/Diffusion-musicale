<?php 
    ...
    $db = dbConnect();
    var_dump($_SESSION);
    // Vérifie que l'utilisateur connecté à le rôle artist et récupère les idenfiants de l'utilisateur
    ...
    {
        // Sinon s'il n'a pas le rôle artiste il vérifie sur la table user et récupère s'il y a le compte user.
